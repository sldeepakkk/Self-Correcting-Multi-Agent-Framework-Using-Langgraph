...
# Same queries through Groq with zero context augmentation.
# Used by run_benchmark.py to generate the comparison table.
# """
# import sys, os
...
#     """
#     Runs the query through Groq with no retrieval, no cache, no judge.
#     This is the baseline — what the model knows from training data alone.
#     """
#     start = time.time()
...
# ) -> dict:
#     """
#     Uses a separate judge LLM to score a response 0-10 on three axes.
#     Same judge for both plain LLM and framework — fair comparison.
#     """
#     llm = ChatGroq(
#         api_key=GROQ_API_KEY,
